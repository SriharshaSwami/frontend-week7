...
function Products(){
    ...
    return(
      <div className="min-h-screen bg-linear-to-br from-amber-100 to-amber-300 py-10 px-6">
        <h1 className="text-4xl font-bold text-center mb-10 text-amber-900 drop-shadow-lg">Product Gallery</h1>
